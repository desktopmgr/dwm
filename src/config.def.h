...
static const char *dmenucmd[]    = { "dmenu_run", "-g", "10", "-l", "20", "-p", "Run: ", NULL };

/* open terminal */
static const char *termcmd[] = {"myterminal", NULL};
/* open browser */
static const char *tabtermcmd[] = {"mybrowser", "''", NULL};
...
static Key keys[] = {
		...
		{MODKEY | Mod1Mask, -1, XK_s, spawn, CMD("mybrowser")},
		{MODKEY | Mod1Mask, -1, XK_b, spawn, CMD("mybrowser")},
		{MODKEY | Mod1Mask, -1, XK_m, spawn, CMD("myemail")},
		{MODKEY | Mod1Mask, -1, XK_f, spawn, CMD("myfilemanager")},

		/* Dmenu scripts launched with emacs-style keychords SUPER + p followed by "key" */
		{MODKEY, XK_p, XK_e, spawn, CMD("dmenu_edit_conf")},
		{MODKEY, XK_p, XK_i, spawn, CMD("screenshot-menu")},
		/* {MODKEY, XK_p, XK_k, spawn, CMD("")},  */
		{MODKEY, XK_p, XK_l, spawn, CMD("logout-menu")},
		/* {MODKEY, XK_p, XK_m, spawn, CMD("./dmscripts/dm-man")},  */
		/* {MODKEY, XK_p, XK_r, spawn, CMD("./dmscripts/dm-reddit")},  */
		{MODKEY, XK_p, XK_s, spawn, CMD("search-menu")},
